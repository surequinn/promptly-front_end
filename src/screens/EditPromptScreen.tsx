        ...
        <View style={[styles.contentView, { maxWidth: innerContentMaxWidth }]}>
          ...
          <View style={styles.inputContainer}>
            <Text style={styles.inputLabel}>
              Didn't quite hit the mark? Tell us what's missing and we'll take
              another swing. What did or didn't work for you? Want a new tone?
              (e.g., more confident, playful, sincere, weirdly poetic) We're all
              ears.
            </Text>
            <TextInput
