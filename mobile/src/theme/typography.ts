...
export const typography = {
  ...
  bodyMd: {
    fontFamily: fonts.interMedium, // Inter_500Medium or Inter_400Regular
  ...
  promptText: {
    fontFamily: fonts.playfairExtraBold, // PlayfairDisplay_800ExtraBold
  ...
  // Button text
  button: {
    fontFamily: fonts.interBold, // Inter_700Bold for large Next buttons
  ...
  buttonSmall: {
    fontFamily: fonts.interSemiBold, // Inter_600SemiBold for Vibe buttons
  ...
  // Special cases
  inputPlaceholder: {
    fontFamily: fonts.interLight, // Inter_200ExtraLight
  ...
  loadingDots: {
    fontFamily: fonts.playfairBold, // PlayfairDisplay_700Bold
  ...
  paytoneOne: {
    fontFamily: fonts.paytoneOneRegular, // PaytoneOne_400Regular
  },
};
